...
export async function connectToMongoDB() {
    ...
    try {
        ...
        const db = dbClient.db(); // Default to db in connection string
...
// 2. splitIntoChunks(text, chunkSize=500, overlap=50)
...
export async function extractTextFromPDF(buffer) {
    try {
        ...
        if (text.length < 100) {
            ...
            // Note: Tesseract.recognize handles buffers
...
// 6. searchRelevantChunks(question, limit=3)
